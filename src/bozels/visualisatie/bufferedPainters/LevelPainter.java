...
/**
  ...
  * 
  */
public class LevelPainter extends BufferedPainter implements LevelListener, GameColorModelListener{

	private final Level level;
	private final GameColorModel cm;
	private final PainterSettingsModel psm;
	
	public LevelPainter(Level level, GameColorModel cm, PainterSettingsModel psm) {
		super(psm);
		this.level = level;
		this.cm = cm;
		this.psm = psm;
